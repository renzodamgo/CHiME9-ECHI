...
class Gromit:
    def __init__(
        ...
        self.train_sisdr = LossTracker()
        self.val_l_sep = LossTracker()
        self.val_sisdr = LossTracker()
    ...
    def epoch_report(
        ...
        train_sisdr = self.train_sisdr.get_average()
